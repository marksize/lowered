...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("babesandnerd-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("babesandnerd-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "babesandnerd " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("babesandnerd-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("babesandnerd-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("babesandnerd-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("babesandnerd-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. babesandnerd is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("babesandnerd-start");
